...
<body>
  ...
  <div class="container">
    <h2 class="text-center mt-5"><?php echo $data['namaLembaga']; ?></h2>
    <div class="img d-flex justify-content-center">
        <img src="../../image/<?php echo $data['logo']; ?>" style="width:60%" alt="">
    </div>
    <h2><?php echo $data['namaLembaga']; ?></h2>
    <!-- <div class="text d-flex justify-content-center mt-2"> -->
        <p style="width: 90%;" ><?php echo $data['deskripsi']; ?></p>
    <!-- </div> -->
    <h2>Visi</h2>
    <div class="text d-flex justify-content-center mt-2">
        <p style="width: 90%;" ><?php echo $data['visi']; ?></p>
    </div>
    <h2>Misi</h2>
    <div class="text d-flex justify-content-center mt-2">
        <p style="width: 90%;" ><?php echo $data['misi']; ?></p>
    </div>
  </div>
