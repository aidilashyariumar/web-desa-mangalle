...
include 'function.php'; // Pastikan nama file dan lokasinya sesuai dengan kebutuhan Anda
...
if(isset($_GET['id'])) {
    ...
    if($affected_rows > 0) {
        ...
        header("Location: index.php"); // Misalnya, arahkan kembali ke halaman indeks
        exit;
    } else {
