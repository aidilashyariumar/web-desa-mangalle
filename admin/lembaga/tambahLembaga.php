	...
	if( tambahLembaga($_POST) > 0 ) {
		...
		echo "
			<script>
				...
				document.location.href = 'tambahLembaga.php';
			</script>
		";
	}
...
<body>
    ...
    <div class="container mt-3" style="width: 60%;">
        <h3 class="text-center">Tambah lembaga</h3>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <textarea type="text" class="form-control" name="deskripsi" id="deskripsi" rows="3"></textarea>
            
            <label for="visi " class="form-label">Visi</label>
            <textarea type="text" class="form-control" name="visi" id="visi" rows="3"></textarea>
            
            <label for="misi " class="form-label">Misi </label>
            <textarea type="text" class="form-control" name="misi" id="misi" rows="3"></textarea>

            <label for="gambar">Logo</label>
            <input type="file" class="form-control" name="logo" id="gambar">
