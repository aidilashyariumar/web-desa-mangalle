...
if( !isset($_SESSION["login"]) ) {
    ...
    $profil = query("SELECT * FROM profil ORDER BY id DESC");
    ...
    <div class="container mt-3">
        ...
        <div class="kepala ">
            <div class="mb-2 d-flex justify-content-between">
                    ...
                    <a href="tambahProfil.php" class="btn btn-success ms-auto">Tambah Data</a>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td class="">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="editBerita.php?id=<?= $prof["id"]; ?>" class="btn btn-warning text-light"><i class="bi bi-pencil-square"></i></a>
                            <a class="btn btn-danger text-light" href="hapus.php?id=<?= $prof["id"]; ?>" onclick="return confirm('yakin?');"><i class="bi bi-trash3-fill"></i></a>
                        </div>
                    </td>
                </tr>
            </tbody>
